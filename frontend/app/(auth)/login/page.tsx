  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input id="phone" type="tel" placeholder="9876543210" className="pl-10" {...register('phone')} disabled={isSubmitting} />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="••••••••" className="pl-10 pr-10" {...register('password')} disabled={isSubmitting} />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox id="remember" checked={rememberMe} onCheckedChange={(checked) => setValue('rememberMe', !!checked)} disabled={isSubmitting} />
      ...
      <div className="mt-6">
        ...
        <Button variant="outline" className="mt-4 w-full" size="lg" onClick={() => router.push('/verify-otp?mode=login')} disabled={isSubmitting}>
          Login with OTP
        </Button>
      </div>
