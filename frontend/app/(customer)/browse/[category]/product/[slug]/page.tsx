  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-10">
          ...
          <div className="bg-white lg:rounded-2xl p-4 lg:p-6 mt-2 lg:mt-0">
            ...
            <div className="flex gap-3 mb-5">
              ...
              <Button size="lg" className="flex-1 bg-orange-500 hover:bg-orange-600 font-bold" onClick={handleBuyNow} disabled={isBuyNowLoading || cartLoading || !canOrder}>
      ...
      <div className="lg:hidden fixed bottom-16 left-0 right-0 z-30 bg-white border-t px-4 py-3 flex gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        ...
        <Button className="flex-1 bg-orange-500 hover:bg-orange-600 font-bold" onClick={handleBuyNow} disabled={isBuyNowLoading || cartLoading || !canOrder}>
