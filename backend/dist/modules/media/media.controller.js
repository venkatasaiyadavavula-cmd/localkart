    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        ...
        fileFilter: (req, file, cb) => {
            ...
            if (!allowedMimes.includes(file.mimetype)) {
                return cb(new common_1.BadRequestException('Invalid file type. Only images and videos allowed.'), false);
            }
            cb(null, true);
        },
    })),
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
        ...
        fileFilter: (req, file, cb) => {
            ...
            if (!allowedVideoTypes.includes(file.mimetype)) {
                return cb(new common_1.BadRequestException('Only video files allowed (mp4, mov, avi, webm)'), false);
            }
            cb(null, true);
        },
    })),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MediaController.prototype, "getVideoStats", null);
__decorate([
