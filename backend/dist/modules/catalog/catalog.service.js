...
let CatalogService = class CatalogService {
    ...
    constructor(productRepository, categoryRepository, shopRepository, subscriptionRepository) {
    ...
    async createProduct(userId, createProductDto) {
        ...
        if (currentProductCount >= limit) {
            throw new common_1.ForbiddenException(`Product limit reached (${currentProductCount}/${limit}) on your ${plan} plan. ` +
