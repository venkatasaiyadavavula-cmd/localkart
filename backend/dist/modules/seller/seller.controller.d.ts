...
export declare class SellerController {
    ...
    constructor(sellerService: SellerService, subscriptionService: SubscriptionService, earningsService: EarningsService, adCampaignService: AdCampaignService, dailyOfferService: DailyOfferService, featuredVideoService: FeaturedVideoService);
    ...
    getFeaturedVideos(user: any): Promise<import("../../core/entities/featured-video.entity").FeaturedVideo[]>;
    promoteFeaturedVideo(user: any, dto: PromoteFeaturedVideoDto): Promise<{
        message: string;
        ...
        shop: import("../../core/entities/shop.entity").Shop;
        productId: string;
        product: import("../../core/entities/product.entity").Product;
        videoUrl: string;
        amount: number;
        status: import("../../core/entities/featured-video.entity").FeaturedVideoStatus;
        expiresAt: Date;
        createdAt: Date;
    }>;
